...
(the st.navigation() router) and every page in app_pages/chuggler/ and
app_pages/dynasty/.
...
def load_all_data():
    ...
    data_dir = Path("ff-dash/data/chuggler")
    file_path = "ff-dash/data/chuggler/2021-2024_stats.csv"
...
def load_draft_data():
    ...
    """
    draft_data_path = Path("ff-dash/data/chuggler/2021-2025_draft_results.csv")
...
def adp_file_status(year):
    ...
    """
    path = Path(f"ff-dash/data/chuggler/ADP_{year}.csv")
    if not path.exists():
